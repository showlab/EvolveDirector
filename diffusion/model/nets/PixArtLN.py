...
from diffusion.model.nets.PixArt_blocks_ln import t2i_modulate, CaptionEmbedder, WindowAttention, MultiHeadCrossAttention, T2IFinalLayer, TimestepEmbedder, LabelEmbedder, FinalLayer
...
#################################################################################
@MODELS.register_module()
def PixArtLN_XL_2(**kwargs):
    return PixArtLN(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)
